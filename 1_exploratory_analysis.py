...
plt.savefig('exploratory_analysis/freq_status.png')
...
plt.savefig('exploratory_analysis/freq_priority.png')
...
plt.savefig('exploratory_analysis/freq_issue_type.png')
...
plt.savefig('exploratory_analysis/freq_resolution.png')
...
plt.savefig('exploratory_analysis/freq_vote_count_log.png')
...
plt.ylabel('N# of alerts')
plt.savefig('exploratory_analysis/freq_comm_count.png')
...
plt.ylabel('N# of alerts')
plt.savefig('exploratory_analysis/freq_descr_length_short.png')
...
plt.xlabel('Length in characters')
plt.ylabel('N# of alerts')
plt.savefig('exploratory_analysis/freq_sum_length.png')
...
plt.ylabel('N# of alerts')
plt.savefig('exploratory_analysis/freq_watch_count.png')
