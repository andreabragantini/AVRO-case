...
plt.savefig('exploratory_analysis/histogram.png', bbox_inches='tight')
plt.close()

print('\n-- Boxplot of the target variable --')
plt.figure(figsize=(12,8))
duration_days.plot.box()
plt.savefig('exploratory_analysis/plotbox.png', bbox_inches='tight')
plt.close()
...
#%% Save Dataset
dropped.to_csv('data_sets/processed.csv', index=False)
