...
with open('data_sets/raw/avro-issues.json','r') as json_file:
...
with open('data_sets/raw/avro-issues.json', 'r', encoding='utf-8') as data_file:    
    data = data_file.read()
...
list_of_alerts = []
for line in open('data_sets/raw/avro-issues.json', 'r'):
